(() => {
  ...
  var logout = async () => {
    try {
      ...
      showAlert("error", "Error, try logging out again.");
      console.log(err);
    }
  };
  ...
  var displayMap = (locations) => {
    mapboxgl.accessToken = "pk.eyJ1IjoiZGFuZTE5OTU4IiwiYSI6ImNtazQ2dG5kZzAwbHQzbHBqYjFvc256YncifQ.YahkInGY73dGgzCqTSP7Ww";
  ...
  var updateUserPassword = async (password, updatePassword, confirmUpdatePassword) => {
    try {
      const res = await axios_default({
        method: "PATCH",
  ...
  var updateForm = document.querySelector(".btn--settings");
  var updatePass = document.querySelector(".btn--pass");
  var logoutBtn = document.querySelector(".nav__el--logout");
  var tourid = document.getElementById("book-tour");
  if (mapEl) {
