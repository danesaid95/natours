...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxLength: [40, 'A name must have a maximum length of 40 characters'],
      minLength: [10, 'A name must have a minimum length of 10 characters'],
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        message:
          'Discount Price ({VALUE}) can not be greater than the price of the tour.',
      },
    },
    summary: {
      type: String,
...
tourSchema.index({ startLocation: '2ds phere' });

tourSchema.virtual('durationWeeks').get(function () {
  return this.duration / 7;
});

//populate reviews when getting a tour
...
//Embedding users to tour document
